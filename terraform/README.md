...
```
curl "http://localhost:8080/demo.tgz?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.standard&runtime=DOCKER&database=NONE.basic&gitops=true" | tar -xzvf -
```
