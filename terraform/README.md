...
```
curl "http://localhost:8080/demo.tgz?iactool=TERRAFORM&region=westeurope&application=CONTAINER_APPS&runtime=DOCKER&database=NONE.free&gitops=true" | tar -xzvf -
```
